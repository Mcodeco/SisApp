...
import com.sis.mcode.sisapp.wizard.model.SandwichWizardModel;
import com.sis.mcode.sisapp.wizard.ui.PageFragmentCallbacks;
import com.sis.mcode.sisapp.wizard.ui.ReviewFragment;
import com.sis.mcode.sisapp.wizard.ui.StepPagerStrip;

import java.util.List;

public class ConsultaActivity extends RoboActionBarActivity implements PageFragmentCallbacks, ReviewFragment.Callbacks, ModelCallbacks {
        ...
        mNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mPager.getCurrentItem() == mCurrentPageSequence.size()) {
                    Intent intent = new Intent(ConsultaActivity.this, ConsultaAfiliadoActivity.class);
