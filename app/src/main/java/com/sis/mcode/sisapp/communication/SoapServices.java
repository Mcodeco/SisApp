...
public class SoapServices {
    ...
    public DownloadListOfTipAfiResult getTipAfi() {
        this.OPERATION_NAME = "ObtenerTiposDeAfiliacion";
        ...
        try {
            ...
            if (soapObject != null) {
                ...
                Type type = new TypeToken<DownloadListOfTipAfiResult>() {
                }.getType();
                DownloadListOfTipAfiResult rslt = gson.fromJson(str_result, type);
                return rslt;
            }
        } catch (SocketTimeoutException e) {
            e.printStackTrace();
            DownloadListOfTipAfiResult rslt = new DownloadListOfTipAfiResult();
            rslt.setErrorMessage("Error de conexi—n. Tiempo de espera agotado.");
            return rslt;
        } catch (IOException e) {
            e.printStackTrace();
        ...
        DownloadListOfTipAfiResult rslt = new DownloadListOfTipAfiResult();
        rslt.setErrorMessage("Ocurrió un error en la descarga de tipos de afiliación");
        return rslt;
    }
    ...
    public DownloadListOfProcAfiResult getProcAfi() {
        ...
        try {
            ...
            if (soapObject != null) {
                ...
                Type type = new TypeToken<DownloadListOfProcAfiResult>() {
                }.getType();
                DownloadListOfProcAfiResult rslt = gson.fromJson(str_result, type);
                return rslt;
            }
        } catch (SocketTimeoutException e) {
            e.printStackTrace();
            DownloadListOfProcAfiResult rslt = new DownloadListOfProcAfiResult();
            rslt.setErrorMessage("Error de conexi—n. Tiempo de espera agotado.");
            return rslt;
        } catch (IOException e) {
            e.printStackTrace();
        ...
        DownloadListOfProcAfiResult rslt = new DownloadListOfProcAfiResult();
        rslt.setErrorMessage("Ocurrió un error en la descarga de procedimientos de afiliación");
        return rslt;
    }

    public DownloadListOfProcAteResult getProcAte() {
        ...
        try {
            ...
            if (soapObject != null) {
                ...
                Type type = new TypeToken<DownloadListOfProcAteResult>() {
                }.getType();
                DownloadListOfProcAteResult rslt = gson.fromJson(str_result, type);
                return rslt;
            }
        } catch (SocketTimeoutException e) {
            e.printStackTrace();
            DownloadListOfProcAteResult rslt = new DownloadListOfProcAteResult();
            rslt.setErrorMessage("Error de conexi—n. Tiempo de espera agotado.");
            return rslt;
        } catch (IOException e) {
            e.printStackTrace();
        ...
        DownloadListOfProcAteResult rslt = new DownloadListOfProcAteResult();
        rslt.setErrorMessage("Ocurrió un error en la descarga de procedimientos de atención");
        return rslt;
    }

    public DownloadListOfReqAfiResult getReqAfi() {
        this.OPERATION_NAME = "ObtenerRequisitosDeAfiliacion";
        ...
        try {
            ...
            if (soapObject != null) {
                ...
                Type type = new TypeToken<DownloadListOfReqAfiResult>() {
                }.getType();
                DownloadListOfReqAfiResult rslt = gson.fromJson(str_result, type);
                return rslt;
            }
        } catch (SocketTimeoutException e) {
            e.printStackTrace();
            DownloadListOfReqAfiResult rslt = new DownloadListOfReqAfiResult();
            rslt.setErrorMessage("Error de conexi—n. Tiempo de espera agotado.");
            return rslt;
        } catch (IOException e) {
            e.printStackTrace();
        ...
        DownloadListOfReqAfiResult rslt = new DownloadListOfReqAfiResult();
        rslt.setErrorMessage("Ocurrió un error en la descarga de requisitos de afiliación");
        return rslt;
    }

    public DownloadListOfReqAteResult getReqAte() {
        this.OPERATION_NAME = "ObtenerRequisitosDeAtencion";
        ...
        try {
            ...
            if (soapObject != null) {
                ...
                Type type = new TypeToken<DownloadListOfReqAteResult>() {
                }.getType();
                DownloadListOfReqAteResult rslt = gson.fromJson(str_result, type);
                return rslt;
            }
        } catch (SocketTimeoutException e) {
            e.printStackTrace();
            DownloadListOfReqAteResult rslt = new DownloadListOfReqAteResult();
            rslt.setErrorMessage("Error de conexi—n. Tiempo de espera agotado.");
            return rslt;
        } catch (IOException e) {
            e.printStackTrace();
        ...
        DownloadListOfReqAteResult rslt = new DownloadListOfReqAteResult();
        rslt.setErrorMessage("Ocurrió un error en la descarga de requisitos de atención");
        return rslt;
    }
